...
def acmark(n,m,k,d,max_deg,M,D,H,phi_c=1,omega=0.2,r=50,step=100,att_type="normal",woAP=False,woITS=False):
...
def acmark_simple(n,m,k,d,max_deg,density,H,phi_c=1,omega=0.2,r=50,step=100,att_type="normal"):
    # node degree generation 
    theta = node_deg(n,m,max_deg)
...
def acmark_reproduction(S,Label,H,d,n=0,m=0,max_deg=0,omega=0.2,r=50,step=100,att_type="normal"):
...
def acmark_only_att(n,m,k,d,max_deg,M,D,H,phi_c=1,omega=0.2,r=50,step=100,att_type="normal",woAP=False,woITS=False):
    # node degree generation 
#     theta = node_deg(n,m,max_deg)
#     line_warn(sum(theta)/2)
